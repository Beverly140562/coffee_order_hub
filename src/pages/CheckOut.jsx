  ...
  return (
    <section className="min-h-screen bg-[#C7AD7F] px-4 sm:px-6 md:px-10 py-6 scrollbar-none">
      ...
      <div className="bg-[#D9D9D9] p-3 sm:p-5 rounded-xl shadow mb-5 max-w-md mx-auto">
        ...
        <h2 className="text-xl sm:text-xl text-black mb-2 pl-1 sm:pl-3">Pickup</h2>
      ...
      <div className="max-w-md mx-auto">
        <button onClick={handleConfirm} className="w-full bg-[#E7524E] text-black py-3 sm:py-4 text-3xl sm:text-2xl font-semibold">
          Confirm Order
        </button>
      </div>
