...
function ProfilePage() {
  ...
  const [user, setUser] = useState({ last_name: "", email: "" });
  ...
  return (
    <section className="min-h-screen bg-[#C7AD7F] px-4 sm:px-6 py-10">
      ...
      <div className="flex flex-col items-start mb-10 space-y-1">
        <h1 className="text-xl sm:text-4xl text-black">Username: {user.last_name}</h1>
